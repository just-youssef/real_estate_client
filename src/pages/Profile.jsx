...
const Profile = () => {
  ...
  const deleteAccount = async()=>{
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_ROOT}/api/user/delete`, {
        method: 'DELETE',
        headers: {
          'x-auth-token': token,
        },
  ...
  const uploadImage = async(e)=>{
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_ROOT}/api/cloudinary/uploadFile`, {
        method: 'POST',
        headers: {
          'x-auth-token': token,
        },
  ...
  const handleUpdate = async(e) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_ROOT}/api/user/update`, {
        method: "POST",
        headers: {
          'x-auth-token': token,
  ...
  const changePassword = async (e) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_ROOT}/api/user/changePassword`, {
        method: "POST",
        headers: {
          'x-auth-token': token,
          'Accept': 'application/json',
