...
const Home = () => {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_ROOT}/api/listing/search?offer=true&limit=4`);
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_ROOT}/api/listing/search?type=rent&limit=4`);
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_ROOT}/api/listing/search?type=sell&limit=4`);
        const data = await res.json();
